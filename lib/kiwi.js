...
Kiwi.v.prototype = {
  ...
  register_listeners: function(){
    ...
    $.each(this.listeners, function(key, value){
      ...
      value = $.extend({callback: 'update', subscribe: true, on_error: null, show_loader: true, unbind: true, prevent_default: true, live: true}, value);
      ...
      view.bind(full_selector, event_name, callback, value.live);   
    });
  },
  ...
  initialize_partials: function(){
    ...
    $.each(view.node.next('.partials').children(), function(){
      ...
      template.render_with = function(data, exclude){
        return Kiwi.helpers.prototype.render_with(this, data, exclude)
      }
