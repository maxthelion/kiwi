...
Kiwi.v.prototype = {
  ...
  initialize_sub_partials: function(){
    var view = this;
    $.each(this.node.next('.sub_partials').children(), function(){
      if ($(this)[0].className == "") {return;}
      var template = view[($(this)[0].className)] = $(this).clone();
